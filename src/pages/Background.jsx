...
<div className="fixed inset-0 overflow-hidden bg-black transition-all duration-300">
  {/* Deep Black-Red Base Gradient */}
  <div className="absolute inset-0 bg-linear-to-b from-[#080001] via-[#0D0003] to-[#020000]" />
